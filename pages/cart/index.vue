                ...
                <div class="px-5 xl:px-10 pt-5">
                    <div class="p-5 flex flex-col border border-gray-300 rounded-md" v-if="!loading.cart && items.length > 0">
                        ...
                        <div class="flex flex-col">
                            ...
                            <div v-if="$settings.sections.cart.buttons.show_back_to_shop" class="mt-5 cursor-pointer flex items-center justify-center border border-black rounded-full p-4 ml-font-bold-hover">
                                <nuxt-link to="/shop">
            ...
            <div v-if="$settings.sections.cart.upsell.active" class="flex flex-col bg-white">
                ...
                <div class="flex flex-wrap mx-1 xl:mx-5" v-if="upsells.length > 0">
                    <template v-for="(upsell, i) in upsells">
                        <div v-for="(product, ii) in upsell.products" :key="ii+'_'+i" class="w-1/2 md:w-1/4 lg:w-1/4 px-4 xl:px-5 mb-4 lg:mb-8">
