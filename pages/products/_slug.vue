<template>
    ...
    <div class="p-2 modal_variante_content">
      <div class="row fs-1-2 ai-c fw-b mb-2">
       <p>{{ t('check_choice') }}</p>
       <span class="c-p px-2 b-b br-8" @click="showVarianteModal = false">X</span>
      </div>

      <div class="w-f mb-1 row">
      ...
      <div class="text-div w-f ai-c">
        ...
        <div class="d-f ai-c w-f border-solid mb-1" @click="showVariantDiv = !showVariantDiv">
...
export default {
    ...
    methods: {
      ...
      return langs[key] && langs[key][this.$store.state.language.code] || key;
    },
        addToCart() {
