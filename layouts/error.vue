    ...
    <div class="container">
		<div class="row">
			<div class="text-gray-50 text-center py-24 flex items-center flex-col">
				...
				<a href="/shop" class="border border-primary ml-font-bold-hover  inline-flex px-5 py-3 text-sm shadow-sm font-bold tracking-wider rounded-full transition delay-200 ease-linear scale">{{ $settings.sections._404.buttons.back_to_shop_text }}</a>
			</div>
		</div>
	</div>
</template>
