<template>
    <div>
        ...
        <div class="flex flex-wrap items-center price" v-if="type=='simple'">
        ...
        <div class="flex flex-wrap items-center price" v-else-if="minPrice != maxPrice">
        ...
        <div class="flex flex-wrap items-center price" v-else-if="variants.length > 0">
