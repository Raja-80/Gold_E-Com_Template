  ...
  <div class="">
    ...
    <div class="relative">
      ...
      <div v-if="items.length > 2">
        <button aria-label="chivron-left" class="absolute top-1/2 left-0  transform -translate-y-1/2 rounded-full" @click="move(-1)">
        ...
        <button aria-label="chivron-right" class="absolute top-1/2 right-0 transform -translate-y-1/2 rounded-full" @click="move(1)">
