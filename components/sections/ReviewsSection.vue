<template>
    ...
    <div class="px-12 lg:py-32 py-16 " style="background-color: #f7f4ef;">
        <div class="flex flex-col justify-center items-center w-full">
            ...
            <h1 v-if="!loading && reviews.results.length > 0 && $settings.sections.reviews.show_title" class="text-black font-semibold lg:text-3xl md:text-2xl sm:text-xl text-xl text-center w-full lg:pb-24 pb-14">

                {{ $settings.sections.reviews.title}}
            ...
            <div class="w-full">
                ...
                <carousel v-if=" !loading && reviews.results.length > 0 " 
...
export default {
    ...
    data() {
        return {
            ...
            reviewsSection: this.$settings.sections.reveiws,
            loading: true
        }
    },
