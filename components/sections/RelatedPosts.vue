<template>
  <div class="mb-16" v-if="items.length > 0">
    ...
    <div class="flex justify-center" v-if="$settings.sections.posts.show_more_text">
      <nuxt-link class="h-12 px-12 flex justify-center items-center border border-black century-bold-hover rounded-full transition-all ease-linear delay-75" to="/blog">
